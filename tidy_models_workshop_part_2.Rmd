...
For resampling of our data, we will use [**Cross Validation**](3.1.%20Cross-validation:%20evaluating%20estimator%20performance%20—%20scikit-learn%201.4.2%20documentation)**.** We first define an object that holds information on how resampling is done.
